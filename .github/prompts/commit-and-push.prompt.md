---
mode: agent
description: Analiza los cambios del repo, genera commits siguiendo la convención ECI (feat/fix/docs/chore…) y hace push al remoto, creando la rama remota si no existe.
tools:
  - terminal
---
...
Antes de ejecutar, muestra el plan completo:

```
CommitPlan:
  1. <prefijo>: <mensaje>
     Archivos: <lista de archivos>
     Rationale: <motivo en una línea>
  2. ...
